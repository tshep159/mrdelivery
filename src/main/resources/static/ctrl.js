...
//        alert("login Controller active");
        $http({
            ...
            function successCallback(respose){
                ...
                localStorage.setItem('id',JSON.stringify(user.product_id) );
                console.log(respose);
                if(user.role==="admin" ){
                    alert("Success");
                    $location.url('/admin');
...
//	$scope.putMessage;
//    /**Retrieving Products from the Database**/
//    $http.get("/products/alls").then(function(response){
//            $scope.products = response.data;
// 
//            if($scope.products.length){ 
//				$scope.selectedCustomer = $scope.products[0];
//			}
//		}, function error(response) {
//			$scope.postResultMessage = "Error Status: " +  response.statusText;
//      
...
//		if($scope.products.length){
//			$scope.selectedCustomer = $scope.products[index]; 	
//		}
//	};
//        
//	// using http PUT to update the changed customer info 
...
//		if($scope.selectedCustomer){
//			// put URL
//			var url = "/update/" + $scope.selectedCustomer.product_id;
//			
//			// prepare headers for posting
//			var config = {
//	                headers : {
...
//				$scope.putMessage = "Error!";
//			});
//	console.log($scope.selectedCustomer.product_id);	}
//	};
//  
    
//    $http.post("/rest/"+$scope.rest.product_id+"/product").then(function(response){
...
//        'cvv': $scope.pay.cvv,
 ...
 $scope.pay = function(){
  ...
  $scope.address = function(){
      ...
      var paymentProcess= $http.post(url,addresses)
              .then(function(response){
